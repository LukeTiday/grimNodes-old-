/*Lukes ChatGPT summary
This JavaScript file is a synthesizer that works in a web browser. 
It can create and play musical notes. 
It has a check to ensure the browser can handle audio features 
and defines a way to make different musical instruments like pianos and organs digitally. 

The code lets you set how the instruments sound 
and play them directly in the browser. 
You can only have one synthesizer at a time (singleton pattern), 
and you can customize how it makes sounds with your own settings. 
It turns these sounds into audio files that can be played on a webpage.
*/
